...
rule vcf2excel:
    ...
    shell:
        "(python3.6 {params.dir}/src/report/vcf2excel.py {input.snv} {input.indel} cnvSeg cnvPng {params.seqID} {input.cart} {params.coverage} \
        {input.bed} cnvbed cnvCyto {input.hotspot} {input.artefact} {input.germline} {input.hematoCount} {input.variantsLog} {output}) &> {log}"
